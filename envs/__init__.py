...
register(
    id='Walker2dTest-v1',
    entry_point='gym.envs.mujoco:Walker2dTestEnv',
    max_episode_steps=10000,
)

register(
    id='Walker2dJump-v2',
    entry_point='gym.envs.skills:Walker2dJump2Env',
    max_episode_steps=1000,
)

register(
    id='Walker2dCrawl-v2',
    entry_point='gym.envs.skills:Walker2dCrawl2Env',
    max_episode_steps=1000,
)

register(
    id='Walker2dFrogJump-v1',
    entry_point='gym.envs.skills:Walker2dFrogJumpEnv',
    max_episode_steps=1000,
)
...
register(
    id='Walker2dFrogJumpForward-v1',
    entry_point='gym.envs.skills:Walker2dFrogJumpForwardEnv',
    max_episode_steps=1000,
)

register(
    id='Walker2dHighKneeRun-v1',
    entry_point='gym.envs.skills:Walker2dHighKneeRun1Env',
    max_episode_steps=1000,
)

register(
    id='Walker2dHighKneeRun-v2',
    entry_point='gym.envs.skills:Walker2dHighKneeRun2Env',
    max_episode_steps=1000,
)

register(
    id='Walker2dForward-v1',
    entry_point='gym.envs.skills:Walker2dForwardEnv',
    max_episode_steps=1000,
)

register(
    id='Walker2dBackward-v1',
    entry_point='gym.envs.skills:Walker2dBackwardEnv',
    max_episode_steps=1000,
)

register(
    id='Walker2dBalance-v1',
    entry_point='gym.envs.skills:Walker2dBalanceEnv',
    max_episode_steps=1000,
)

register(
    id='Walker2dJump-v1',
    entry_point='gym.envs.skills:Walker2dJumpEnv',
    max_episode_steps=1000,
)

register(
    id='Walker2dCrawl-v1',
    entry_point='gym.envs.skills:Walker2dCrawlEnv',
    max_episode_steps=1000,
)
...
register(
    ...
    entry_point='gym.envs.skills:Walker2dPatrolEnv',
    max_episode_steps=10000,
)
...
register(
    ...
    entry_point='gym.envs.skills:Walker2dHurdleEnv',
...
register(
    ...
    entry_point='gym.envs.skills:Walker2dObstacleCourseEnv',
    max_episode_steps=5000,
)

# forward velocities
register(
    id='Walker2dForward_vel_1-v1',
    entry_point='gym.envs.skills:Walker2dForwardEnv_vel_1',
    max_episode_steps=1000,
)

register(
    id='Walker2dForward_vel_2-v1',
    entry_point='gym.envs.skills:Walker2dForwardEnv_vel_2',
    max_episode_steps=1000,
)

register(
    id='Walker2dForward_vel_3-v1',
    entry_point='gym.envs.skills:Walker2dForwardEnv_vel_3',
    max_episode_steps=1000,
)

register(
    id='Walker2dForward_vel_4-v1',
    entry_point='gym.envs.skills:Walker2dForwardEnv_vel_4',
    max_episode_steps=1000,
)

register(
    id='Walker2dForward_vel_5-v1',
    entry_point='gym.envs.skills:Walker2dForwardEnv_vel_5',
    max_episode_steps=1000,
)

register(
    id='Walker2dForward_vel_6-v1',
    entry_point='gym.envs.skills:Walker2dForwardEnv_vel_6',
    max_episode_steps=1000,
)

register(
    id='Walker2dBackward_vel_1-v1',
    entry_point='gym.envs.skills:Walker2dBackwardEnv_vel_1',
    max_episode_steps=1000,
)

register(
    id='Walker2dBackward_vel_2-v1',
    entry_point='gym.envs.skills:Walker2dBackwardEnv_vel_2',
    max_episode_steps=1000,
)

register(
    id='Walker2dBackward_vel_3-v1',
    entry_point='gym.envs.skills:Walker2dBackwardEnv_vel_3',
    max_episode_steps=1000,
)

register(
    id='Walker2dBackward_vel_4-v1',
    entry_point='gym.envs.skills:Walker2dBackwardEnv_vel_4',
    max_episode_steps=1000,
)

register(
    id='Walker2dBackward_vel_5-v1',
    entry_point='gym.envs.skills:Walker2dBackwardEnv_vel_5',
    max_episode_steps=1000,
)

register(
    id='Walker2dBackward_vel_6-v1',
    entry_point='gym.envs.skills:Walker2dBackwardEnv_vel_6',
    max_episode_steps=1000,
)
