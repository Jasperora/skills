...
class Walker2dFrogJumpForwardEnv(Walker2dEnv):
    def __init__(self):
        super().__init__()
        ...
        self.reward_type += ["x_vel_reward", "alive_reward", "angle_reward",
                             ...
                             "jump_reward", "thigh_foot_reward", "height_diff_reward", "x_vel_mean", 
                             "height_mean", "nz_mean", "delta_h_mean"]
